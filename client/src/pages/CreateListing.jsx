    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1 '>
                <input className='border rounded-lg p-3' type='text' placeholder='Name' id="name" maxLength="62" minLength="10" required />
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    ...
                    <button className= 'border border-green-700 text-green-700 uppercase p-3 rounded hover:shadow-lg disabled:opacity-80'>Upload</button>
                </div>
